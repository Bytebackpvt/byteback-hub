...
export function BrandMark({ className = "" }: { className?: string }) {
  return (
    <span className={`inline-flex min-w-0 items-center gap-2 ${className}`}>
      <span className="relative grid h-7 w-7 shrink-0 place-items-center rounded-lg bg-foreground text-background shadow-sm">
      ...
      <span className="brand-text min-w-0 truncate text-[15px] font-semibold tracking-tight">
